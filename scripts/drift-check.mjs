...
const PACKS = isDevinRepo
  ? [['plugins/pstack', 'pstack'], ['plugins/cursor-team-kit', 'cursor-team-kit'], ['plugins/lua-kit', 'lua-kit'], ['plugins/typescript-kit', 'typescript-kit'], ['plugins/python-kit', 'python-kit'], ['plugins/go-kit', 'go-kit'], ['plugins/shell-kit', 'shell-kit'], ['plugins/rust-kit', 'rust-kit'], ['plugins/c-kit', 'c-kit'], ['plugins/cpp-kit', 'cpp-kit'], ['plugins/java-kit', 'java-kit']]
  : [['pstack', 'pstack'], ['cursor-team-kit', 'cursor-team-kit'], ['lua-kit', 'lua-kit'], ['typescript-kit', 'typescript-kit'], ['python-kit', 'python-kit'], ['go-kit', 'go-kit'], ['shell-kit', 'shell-kit'], ['rust-kit', 'rust-kit'], ['c-kit', 'c-kit'], ['cpp-kit', 'cpp-kit'], ['java-kit', 'java-kit']];
