...
const PACKS = isDevinRepo
  ? [['plugins/pstack', 'pstack'], ['plugins/cursor-team-kit', 'cursor-team-kit'], ['plugins/lua-kit', 'lua-kit'], ['plugins/typescript-kit', 'typescript-kit']]
  : [['pstack', 'pstack'], ['cursor-team-kit', 'cursor-team-kit'], ['lua-kit', 'lua-kit'], ['typescript-kit', 'typescript-kit']];
