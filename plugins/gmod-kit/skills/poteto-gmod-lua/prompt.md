...
Done means EXIT PREDICATE in poteto-gmod-lua (rg gate 0; no narrating comments; smallest diff; net/hot-hook rules if touched; coverage script 0 if UI; real load/net proof)
