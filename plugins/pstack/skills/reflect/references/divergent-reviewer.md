...
- `Read` tool calls against any `SKILL.md` file (workspace `.devin/skills/`, user-level `~/.config/devin/skills/`, or plugin-installed paths under `the plugin cache under `)
