...
- Upstream: [`cursor/plugins/pstack`](https://github.com/cursor/plugins/tree/main/pstack) v0.15.1
...
- Upstream: [`cursor/plugins/cursor-team-kit`](https://github.com/cursor/plugins/tree/main/cursor-team-kit) v1.2.0
